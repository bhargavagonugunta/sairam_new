  ...
  function handleAddCartItem({item} : SqCardPropType) {
    ...
    return(
      ...
      <div className="flex flex-col items-center">
        ...
        <h1 className="text-4xl text-center font-semibold">TRUE CAKES & DESSERTS</h1>
      </div>
        ...
        {CakeData.map((item) => {
          return (
            ...
            <motion.button onClick={() => { handleAddCartItem({ item: { ...item, quantity: 1 } }) }} className="border border-white bg-transparent px-1 md:px-6 md:py-1 rounded-full"
